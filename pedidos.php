...
if ($modo === 'simple') {
    ...
    $productos_stmt = $conexion->prepare("
        ...
        WHERE p.store_id = ?
    ");
    $productos_stmt->bind_param("i", $store_id);

} else {

    // 🔹 MODO CONTROLADO: cálculo normal
    $productos_stmt = $conexion->prepare("
        SELECT p.id, p.name, p.price,
    ...
    <main class="container my-5">
        <div class="container mt-4">
            ...
            <div class="mb-3">
                ...
                <input type="text" id="client" class="form-control" placeholder="Ingrese el nombre del cliente"
                    required>
            </div>
            ...
            <div class="mb-4">
                ...
                <textarea id="comment" class="form-control" rows="2"
                    placeholder="Notas especiales para este pedido..."></textarea>
            </div>
